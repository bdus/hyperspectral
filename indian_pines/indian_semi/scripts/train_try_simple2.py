# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 20:24:08 2019
...
net.load_parameters(os.path.join(this_dir,'..','symbols','para','%s.params'%("indian_simple20.870362")) )
...
def ematrain(epochs,alpha=0,beta=0,lr=0.1):
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 50 == 0:
            ...
            if val_acc+acc > val_acc_bk and acc >= 0.99:
                print('[Epoch %d] Validation: %s=%f'%(epoch, name, val_acc))
