# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 21:51:52 2019
...
modelname = 'indian_simple_ema_uset1'
...
net_t.load_parameters(os.path.join(this_dir,'..','symbols','para','%s.params'%("indian_simple_ema_uset0.847255"))  )
#net.initialize(mx.init.Normal(0.5) ,ctx=ctx)
net.load_parameters(os.path.join(this_dir,'..','symbols','para','%s.params'%("indian_simple_ema_uset0.847255")) )
